<?php
// Cek jika user sudah login dan perannya user
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#tiga_besar" role="tab" aria-controls="pills-profile" aria-selected="false">Data Hasil 3 Besar</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="tiga_besar" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <h2 class="mb-0">
                                                <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                                    Data Laki - Laki (3 Besar)
                                                </button>
                                            </h2>
                                        </div>
